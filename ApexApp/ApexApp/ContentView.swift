...
struct ContentView: View {
            ...
            LazyVGrid(columns: Array(repeating: GridItem(.flexible()), count: 2), spacing: 8) {
                ForEach(chartTypes, id: \.self) { chartType in
                    Button(action: {
                        ...
                        .background(selectedChartType == chartType ? Color.blue.opacity(0.2) : Color(.controlBackgroundColor))
                        .cornerRadius(8)
                        .overlay(
    ...
    private func updateChart() {
        ...
        print("🔄 [ContentView] Updating chart: \(selectedChartType) with X:\(selectedXAxis) Y:\(selectedYAxis)")
